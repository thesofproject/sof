...
LOG_MODULE_DECLARE(sof, CONFIG_SOF_LOG_LEVEL);
#endif
...
#define _trace_event_with_ids(class, id_0, id_1, has_ids, format, ...)	\
	_log_message(__mbox,, LOG_LEVEL_INF, class, id_0, id_1,	\
		     has_ids, format, ##__VA_ARGS__)
#define _trace_event_atomic_with_ids(class, id_0, id_1, has_ids, format, ...)\
	_log_message(__mbox, _atomic, LOG_LEVEL_INF, class, id_0, id_1,  \
		     has_ids, format, ##__VA_ARGS__)
...
/* verbose tracing */
#if CONFIG_SOF_LOG_LEVEL >= LOG_LEVEL_DBG
...
/* error tracing */
#if CONFIG_SOF_LOG_LEVEL >= LOG_LEVEL_ERR
#define _trace_error_with_ids(class, id_0, id_1, has_ids, format, ...)	\
	_log_message(_mbox, _atomic, LOG_LEVEL_ERR, class, id_0,	\
...
#define _log_message(mbox, atomic, level, comp_class, id_0, id_1,	\
		     has_ids, format, ...)				\
do {									\
	Z_LOG(level, "%s " format, get_trace_class(comp_class),		\
	      ##__VA_ARGS__);						\
} while (0)

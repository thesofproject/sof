 ...
 */
void *drv_heap_aligned_alloc(struct sys_heap *drv_heap, uint32_t flags, uint32_t caps, size_t bytes,
			     int32_t align);
 ...
 */
void *drv_heap_rmalloc(struct sys_heap *drv_heap, enum mem_zone zone, uint32_t flags, uint32_t caps,
		       size_t bytes);

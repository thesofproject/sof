...
static struct comp_dev *test_src_create(void)
{
...
/* Test src initialization */
ZTEST(audio_src, test_src_init)
{
	struct comp_dev *comp = test_src_create();
...
ZTEST(audio_src, test_src_config)
{
	struct comp_dev *comp = test_src_create();
...
ZTEST(audio_src, test_src_process)
{
	struct comp_dev *comp = test_src_create();

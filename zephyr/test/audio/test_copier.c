...
static struct comp_dev *test_copier_create(void)
{
...
{
	struct comp_dev *comp = test_copier_create();
...
ZTEST(audio_copier, test_copier_config)
{
	struct comp_dev *comp = test_copier_create();
...
ZTEST(audio_copier, test_copier_process)
{
	struct comp_dev *comp = test_copier_create();

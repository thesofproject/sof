...
static struct comp_dev *test_codec_create(void)
{
...
{
	struct comp_dev *comp = test_codec_create();
...
ZTEST(audio_codec, test_passthrough_config)
{
	struct comp_dev *comp = test_codec_create();
...
ZTEST(audio_codec, test_passthrough_process)
{
	struct comp_dev *comp = test_codec_create();

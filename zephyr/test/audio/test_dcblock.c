...
static struct comp_dev *test_dcblock_create(void)
{
...
{
	struct comp_dev *comp = test_dcblock_create();
...
ZTEST(audio_dcblock, test_dcblock_config)
{
	struct comp_dev *comp = test_dcblock_create();
...
ZTEST(audio_dcblock, test_dcblock_process)
{
	struct comp_dev *comp = test_dcblock_create();

...
static struct comp_dev *test_crossover_create(void)
{
...
{
	struct comp_dev *comp = test_crossover_create();
...
ZTEST(audio_crossover, test_crossover_config)
{
	struct comp_dev *comp = test_crossover_create();
...
ZTEST(audio_crossover, test_crossover_process)
{
	struct comp_dev *comp = test_crossover_create();

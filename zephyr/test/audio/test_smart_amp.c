...
static struct comp_dev *test_smart_amp_create(void)
{
...
{
	struct comp_dev *comp = test_smart_amp_create();
...
ZTEST(audio_smart_amp, test_smart_amp_config)
{
	struct comp_dev *comp = test_smart_amp_create();
...
ZTEST(audio_smart_amp, test_smart_amp_process)
{
	struct comp_dev *comp = test_smart_amp_create();

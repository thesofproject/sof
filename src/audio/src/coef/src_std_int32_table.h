...
const int src_in_fs[15] = { 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100,
	 48000, 50000, 64000, 88200, 96000, 176400, 192000};
const int src_out_fs[10] = { 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100,
	 48000, 50000};
const struct src_stage * const src_table1[10][15] = {
...
const struct src_stage * const src_table2[10][15] = {
	{ &src_int32_1_1_0_0, &src_int32_0_0_0_0,

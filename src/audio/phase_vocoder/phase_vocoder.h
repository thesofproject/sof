 ...
 * @reserved_pad: Reserved for future use, kept for ABI compatibility
 ...
 * @polar_buffer: Base address of the joint polar/angle/output-phase allocation
 ...
 * @phase_vocoder_polar_bytes: Size in bytes of the joint polar allocation

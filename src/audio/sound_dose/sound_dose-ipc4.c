...
int sound_dose_ipc_notification_init(struct processing_module *mod)
{
	...
	cd->msg = sound_dose_notification_init(mod, SOF_SOUND_DOSE_PAYLOAD_PARAM_ID, 0);
	if (!cd->msg) {

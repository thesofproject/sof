...
#if defined(CONFIG_COMP_MWW_MODEL_HEY_JARVIS)
#include "mww_model_data_hey_jarvis.h"
#define MWW_BUILTIN_MODEL_DATA mww_model_data_hey_jarvis
#else
#include "mww_model_data_hi_intel.h"
#define MWW_BUILTIN_MODEL_DATA mww_model_data_hi_intel
#endif
#endif
...
#if !CONFIG_COMP_MWW_MODEL_FROM_CONTROL
	if (!model_tflite)
		model_tflite = const_cast<unsigned char *>(MWW_BUILTIN_MODEL_DATA);
#endif

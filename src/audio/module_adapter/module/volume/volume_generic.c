...
/**
 * \brief Volume bypass from 24/32 bit to 24/32 bit.
 * \param[in,out] dev Volume base component device.
 * \param[in,out] sink Destination buffer.
 * \param[in,out] source Input buffer.
 * \param[in] frames Number of frames to process.
 ...
 * to 24/32 bit destination buffer.
 */
static void vol_bypass_s24_to_s24(struct processing_module *mod,
...
/**
 * \brief Volume bypass from 32 bit to 32 bit.
 * \param[in,out] dev Volume base component device.
 * \param[in,out] sink Destination buffer.
 * \param[in,out] source Input buffer.
 * \param[in] frames Number of frames to process.
 ...
 * to 32 bit destination buffer.
 */
static void vol_bypass_s32_to_s32(struct processing_module *mod,
				  struct input_stream_buffer *bsource,
				  struct output_stream_buffer *bsink, uint32_t frames,
				  uint32_t attenuation)
{
...
/**
 * \brief Volume bypass from 16 bit to 16 bit.
 * \param[in,out] dev Volume base component device.
 * \param[in,out] sink Destination buffer.
 * \param[in,out] source Input buffer.
 * \param[in] frames Number of frames to process.
...
#endif
#if CONFIG_FORMAT_S24LE
	{ SOF_IPC_FRAME_S24_4LE, vol_s24_to_s24, vol_bypass_s24_to_s24},
#endif
#if CONFIG_FORMAT_S32LE
	{ SOF_IPC_FRAME_S32_LE, vol_s32_to_s32, vol_bypass_s32_to_s32},
#endif
};

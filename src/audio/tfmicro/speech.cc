...
//constexpr int kAudioSampleFrequency = TFMICRO_SAMPLE_RATE;
constexpr int kFeatureSize = TFMICRO_FEATURE_SIZE;
constexpr int kFeatureCount = TFMICRO_FEATURE_COUNT;
constexpr int kFeatureElementCount = TFMICRO_FEATURE_ELEM_COUNT;

...
static inline int32_t rexp_fixed_arm(int32_t x, int32_t precision_x, int32_t *e)
{
...
static inline int32_t log10_fixed(int32_t x)
{
	...
	/* Horner's rule with ARM SMLAL / shift */
...
int32_t drc_inv_fixed(int32_t x, int32_t precision_x, int32_t precision_y)
{
	...
	x = rexp_fixed_arm(x, precision_x, &e);

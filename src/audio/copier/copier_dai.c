...
__cold int copier_dai_prepare(struct comp_dev *dev, struct copier_data *cd)
{
	int ret;
...
__cold void copier_dai_adjust_params(const struct copier_data *cd,
...
__cold int copier_dai_params(struct copier_data *cd, struct comp_dev *dev,

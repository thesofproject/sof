...
__cold static int create_local_elems(struct host_data *hd, struct comp_dev *dev,
...
__cold static int host_verify_params(struct comp_dev *dev,
...
__cold int host_common_params(struct host_data *hd, struct comp_dev *dev,
...
__cold static int host_params(struct comp_dev *dev,
			      struct sof_ipc_stream_params *params)
{
	struct host_data *hd = comp_get_drvdata(dev);
	int err;
...
__cold int host_common_prepare(struct host_data *hd)
{
	assert_can_be_cold();
...
__cold static int host_prepare(struct comp_dev *dev)
{
	struct host_data *hd = comp_get_drvdata(dev);
	int ret;

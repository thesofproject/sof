...
LOG_MODULE_REGISTER(esp32c6_platform, CONFIG_SOF_LOG_LEVEL);
...
int platform_boot_complete(uint32_t boot_message)
{
	...
	LOG_INF("ESP32-C6 platform boot complete");
	return 0;
}
...
{
	LOG_INF("Initializing ESP32-C6 SOF Platform...");
	...
	LOG_INF("ESP32-C6 SOF Platform initialized successfully");
	return 0;
}

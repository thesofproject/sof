...
#define SRAM_PERFCOUNT_BASE	(SRAM_STREAM_BASE + SRAM_STREAM_SIZE)
#if CONFIG_PERFCOUNT
#define SRAM_PERFCOUNT_SIZE	0x800
#else
#define SRAM_PERFCOUNT_SIZE	0x0
#endif

/* window 3 */
#define SRAM_TRACE_BASE		(SRAM_PERFCOUNT_BASE + SRAM_PERFCOUNT_SIZE)
#if CONFIG_TRACE

...
/* shim */
#define SHIM_BASE               0x00000
#define SHIM_SIZE               0x00000100

/* Digital Mic Shim Registers */
#define DMIC_SHIM_BASE         0x0000C000
...
#define DMICIPPTR              (DMIC_SHIM_BASE + DMICIPPTR_OFFSET)
#define DMICSYNC               (DMIC_SHIM_BASE + DMICSYNC_OFFSET)
...
#define HOST_WIN_BASE(x)        (0x70200 + 8 * x)

/* IRQ controller */
#define IRQ_BASE                0x00078800
#define IRQ_SIZE                0x00000200
#define MS_REG_DxHIPCIE_OFFSET  0x00000040
#define MS_REG_HIPCIS           (IRQ_BASE + MS_REG_DxHIPCIE_OFFSET)
#define MS_REG_DxTTSIE_OFFSET  	0x00000054
#define MS_REG_DxTTSIE 			(IRQ_BASE + MS_REG_DxHIPCIE_OFFSET)
#define DxINTIPPTR_OFFSET       0x8
#define MS_BLOCK_DINTIP         0x0007AC00
#define MS_REG_IRQ_INTMASK_L0_OFFSET	0x8
#define MS_REG_IRQ_INTMASK_L0   (MS_BLOCK_DINTIP + MS_REG_IRQ_INTMASK_L0_OFFSET)
...
/* SSP */
#define SSP_BASE(x)             (0x00028000 + x * SSP_SIZE)
#define SSP_SIZE                0x0001000

/* ALH */
#define ALH_BASE                0x000024400
#define ALH_TXDA_OFFSET         0x000000000
#define ALH_RXDA_OFFSET         0x000000100
#define ALH_STREAM_OFFSET       0x000000004
#define ALHASCTL                ALH_BASE
#define ALHCSCTL                0x000024600
...
/* HP SRAM */
#define HP_SRAM_BASE            0xA0020000
...
/* text and data share the same HP L2 SRAM on Meteorlake */
...
/* LP SRAM */
#define LP_SRAM_BASE                    0xA0000000
...
#define IMR_BOOT_LDR_TEXT_ENTRY_BASE    0xA1048000
...
#define IMR_BOOT_LDR_BSS_BASE           0xA1110000

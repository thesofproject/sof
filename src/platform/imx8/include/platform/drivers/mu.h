...
#ifdef __SOF_DRIVERS_MU_H__

#ifndef __PLATFORM_DRIVERS_MU_H__
#define __PLATFORM_DRIVERS_MU_H__
...
#endif /* __PLATFORM_DRIVERS_MU_H__ */

#else

#error "This file shouldn't be included from outside of sof/drivers/mu.h"

...
LOG_MODULE_REGISTER(esp32s3_platform, CONFIG_SOF_LOG_LEVEL);
...
int platform_boot_complete(uint32_t boot_message)
{
	...
	LOG_INF("ESP32-S3 platform boot complete");
	return 0;
}
...
{
	LOG_INF("Initializing ESP32-S3 SOF Platform...");
	...
	LOG_INF("ESP32-S3 SOF Platform initialized successfully");
	return 0;
}

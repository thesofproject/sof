...
#define DRAM0_SIZE	0x80000
#define DRAM1_SIZE	0x80000
...
#define HS_TX_FIFO_OFFST        (ACP_HS_TX_FIFOADDR - ACP_I2S_RX_RINGBUFADDR)
#define HS_RX_FIFO_OFFST        (ACP_HS_RX_FIFOADDR - ACP_I2S_RX_RINGBUFADDR)
...
#define SRAM_OUTBOX_BASE		0x9FF00000	
...
#define HEAP_RT_COUNT1024	13
#define HEAP_RT_COUNT2048	24

/* Heap section sizes for system runtime heap */
#define HEAP_SYS_RT_COUNT64	64
#define HEAP_SYS_RT_COUNT512	22 /*vangogh-arch*/
#define HEAP_SYS_RT_COUNT1024	30

/* Heap configuration */
#define HEAP_SYSTEM_BASE	(SOF_STACK_BASE + SOF_STACK_SIZE)
#define HEAP_SYSTEM_SIZE	0x14400
...
#define HEAP_BUFFER_SIZE	(0x15400)
...
#define PLATFORM_TASK_DEFAULT_STACK_SIZE        (3072+1024)

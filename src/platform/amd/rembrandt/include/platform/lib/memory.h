...
//+DTS
#define HEAP_RT_COUNT8		(0 + 32)
#define HEAP_RT_COUNT16		(48 + 32)
#define HEAP_RT_COUNT32		(48 + 32)
#define HEAP_RT_COUNT64		(32 + 16)
#define HEAP_RT_COUNT128	(60 + 16)
#define HEAP_RT_COUNT256	(32 + 12)
#define HEAP_RT_COUNT512	(4 + 12)
#define HEAP_RT_COUNT1024	(12 + 12)
#define HEAP_RT_COUNT2048	(12 + 12)

/* Heap section sizes for system runtime heap */
#define HEAP_SYS_RT_COUNT64	(72 + 32)
#define HEAP_SYS_RT_COUNT512	(24 + 16) /*rembrandt-arch*/
#define HEAP_SYS_RT_COUNT1024	(8 + 8)

/* Heap configuration */
#define HEAP_SYSTEM_BASE	SRAM1_BASE
#define HEAP_SYSTEM_SIZE	(0xE000  +  0xE000   +  0xE000)
...
#define HEAP_BUFFER_SIZE	(0xF000  +   0xF000   +  0xF000)

...
typedef union clk5_clk_did_control_u {
    struct {
        unsigned int                    AllowZeroDID_0  : 1;
        unsigned int                    AllowZeroDID_1  : 1;
        unsigned int                    AllowZeroDID_2  : 1;
        unsigned int                                    : 29;
    } bitfields, bits;
    uint32_t    u32All;
    int32_t     i32All;
    float       f32All;
}clk5_clk_did_control_u_t;

typedef union clk5_clk1_dfs_cntl_u {
    struct {
...
typedef union clk5_clk1_dfs_status_u {
    ...
    int32_t     i32All;
    float       f32All;
}clk5_clk1_dfs_status_u_t;

typedef  union clk5_clk1_bypass_cntl_u {
    struct {
    ...
    int32_t     i32All;
    float       f32All;
}clk5_clk1_bypass_cntl_u_t;

typedef union clk5_clk_fsm_status_u {
    struct {
    ...
    int32_t     i32All;
    float       f32All;
}clk5_clk_fsm_status_t;

typedef union clk5_clk_pll_req_u {
    struct {
    ...
    int32_t     i32All;
    float       f32All;
}clk5_clk_pll_req_u_t;

typedef  union clk5_clk_pll_refclk_startup {
    struct {
        unsigned int  MainPllRefclkRateStartup    : 8;
        unsigned int  MainPllCfg4Startup          : 8;
        unsigned int  MainPllRefclkDivStartup     : 2;
        unsigned int  MainPllCfg3Startup          : 10;
        unsigned int                              : 1;
        unsigned int  MainPllRefclkSrcMux0Startup : 1;
        unsigned int  MainPllRefclkSrcMux1Startup : 1;
        unsigned int                              : 1;
    } bitfields, bits;
    uint32_t    u32All;
    int32_t     i32All;
    float       f32All;
}clk5_clk_pll_refclk_startup_t;

typedef union clk5_spll_field_2 {
    struct{
        unsigned int                             : 3;
...
typedef union clk5_clk_dfsbypass_cntl {
    struct {
        unsigned int EnterDFSBypass_0            : 1;
        unsigned int EnterDFSBypass_1            : 1;
        unsigned int                             : 14;
        unsigned int ExitDFSBypass_0             : 1;
        unsigned int ExitDFSBypass_1             : 1;
        unsigned int                             : 14;
    } bitfields, bits;
    uint32_t   u32All;
    int32_t    i32All;
    float      f32All;
}clk5_clk_dfsbypass_cntl_t;

typedef union clk5_clk_pll_pwr_req {
    struct {
    ...
    int32_t     i32All;
    float       f32All;
}clk5_clk_pll_pwr_req_t;

typedef union clk5_spll_fuse_1 {
    struct {
        unsigned int                             : 8;
...
typedef union clk5_spll_fuse_2 {
    struct {
...
typedef union clk5_spll_field_9 {
    struct {
        unsigned int                        : 16;
...
typedef union clk5_spll_field_6nm {
    struct {
    ...
    int32_t    i32All;
    float      f32All;
}clk5_spll_field_6nm_t;

typedef union clk5_spll_field_7 {
    struct {
        unsigned int                            : 7;
...
typedef union clk5_spll_field_4 {
    struct {
        unsigned int spll_fcw0_frac_ovrd    : 16;
        unsigned int PllOutSel              : 1;
        unsigned int                        : 3;
        unsigned int PllPwrDnState          : 2;
        unsigned int                        : 2;
...
typedef union clk5_spll_field_5nm_bus_ctrl {
    struct {
    ...
    int32_t    i32All;
    float      f32All;
}clk5_spll_field_5nm_bus_ctrl_t;

typedef union clk5_spll_field_5nm_bus_wdata {
    struct {
    ...
    int32_t    i32All;
    float      f32All;
}clk5_spll_field_5nm_bus_wdata_t;

typedef union clk5_rootrefclk_mux_1 {
    struct {
    ...
    int32_t    i32All;
    float      f32All;
}clk5_rootrefclk_mux_1_t;

typedef union clk5_spll_field_5nm_bus_status {
    struct {
    ...
    int32_t    i32All;
    float      f32All;
}clk5_spll_field_5nm_bus_status_t;

...
#define MAILBOX_TRACE_BASE	SRAM_TRACE_BASE
 ...
 /* window 2 debug, exception, stream and perfcount */
...
#define MAILBOX_PERFCOUNT_SIZE    SRAM_PERFCOUNT_SIZE
#define MAILBOX_PERFCOUNT_BASE    SRAM_PERFCOUNT_BASE
#define MAILBOX_PERFCOUNT_OFFSET  (SRAM_DEBUG_SIZE + SRAM_EXCEPT_SIZE + \
				   SRAM_STREAM_SIZE)

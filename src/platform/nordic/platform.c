...
LOG_MODULE_REGISTER(nordic_platform, CONFIG_SOF_LOG_LEVEL);

uint8_t sof_nordic_mailbox[0x1000] __aligned(32);
...
int platform_boot_complete(uint32_t boot_message)
{
	...
	LOG_INF("Nordic platform boot complete");
	return 0;
}
...
{
	LOG_INF("Initializing Nordic SOF Platform...");
	...
	LOG_INF("Nordic SOF Platform initialized successfully");
	return 0;
}

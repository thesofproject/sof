...
static const uint32_t nrf54lm20_default_drc_coef[35] = {
...
static const struct sof_static_comp nrf54lm20_comps[] = {
	...
	SOF_STATIC_COMP_MODULE(
		...
		.caps = SOF_STATIC_CAPS(SOF_IPC_FRAME_FLOAT, 48000, 2),
		.init_blob = nrf54lm20_default_iir_coef_2ch,
		.init_blob_size = sizeof(nrf54lm20_default_iir_coef_2ch)
	),
	SOF_STATIC_COMP_MODULE(
		.id = 4, .pipeline_id = 1, .name = "DRC_PB",
		.uuid = &drc_uuid, .direction = SOF_IPC_STREAM_PLAYBACK,
		.caps = SOF_STATIC_CAPS(SOF_IPC_FRAME_FLOAT, 48000, 2),
		.init_blob = nrf54lm20_default_drc_coef,
 ...
 * ------------------------------------------------------------------------- */
static const struct sof_static_buffer nrf54lm20_buffers[] = {
	/* Pipeline 1 Buffers */
 ...
 * ------------------------------------------------------------------------- */
static const struct sof_static_kcontrol nrf54lm20_controls[] = {
 ...
 * ------------------------------------------------------------------------- */
const struct sof_static_topology g_nrf54lm20_static_topology = {
	.name = "nRF54LM20 Static Audio Pipeline",
	.num_pipelines = ARRAY_SIZE(nrf54lm20_pipelines),
	.pipelines = nrf54lm20_pipelines,
	.num_comps = ARRAY_SIZE(nrf54lm20_comps),
	.comps = nrf54lm20_comps,
	.num_buffers = ARRAY_SIZE(nrf54lm20_buffers),
	.buffers = nrf54lm20_buffers,
	.num_routes = ARRAY_SIZE(nrf54lm20_routes),
	.routes = nrf54lm20_routes,
	.num_pcms = 0,
	.pcms = NULL,
	.num_controls = ARRAY_SIZE(nrf54lm20_controls),
	.controls = nrf54lm20_controls,
};

...
/**
 * @brief Structure representing the configuration for DMIC external global settings.
 */
struct dmic_ext_global_cfg {
	/**
...
struct dmic_global_cfg {
	 ...
	 */
	struct dmic_ext_global_cfg ext_cfg;
} __packed __aligned(4);
...
struct dmic_config_blob {
	 ...
	 */
	struct dmic_global_cfg global_cfg;

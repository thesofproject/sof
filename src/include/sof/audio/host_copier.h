...
static int host_zephyr_prepare(struct host_data *hd)
{
	return 0;
}
...
static int host_zephyr_trigger(struct host_data *hd, struct comp_dev *dev, int cmd, uint16_t state)
{
	return 0;
}
...
static int host_zephyr_copy(struct host_data *hd, struct comp_dev *dev)
{
	return 0;
}

static void host_update_position(struct host_data *hd, struct comp_dev *dev, uint32_t bytes) {}

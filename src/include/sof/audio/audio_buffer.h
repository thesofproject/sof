...
/* base class for all buffers, all buffers must inherit from if
 * Inheritance means - must have buffer_abstract as the very first field of the structure
 */
struct sof_audio_buffer {
	 ...
	 */
	void (*free_op)(struct sof_audio_buffer *buffer);
};

...
#define SDMA_ILLINSTADDR	0x0058 /* Illegal instruction trap handler address */
...
#define SDMA_MAX_BDS		4 /* We don't need more than 4 buffer descriptors per channel */
...
/* AP2MCU is host to DSP, slow path but works with DSP OCRAM */
#define SDMA_CHAN_TYPE_AP2MCU		1
#define SDMA_CHAN_TYPE_MCU2AP		2
/* SHP2MCU is host to DSP, faster but only works with SDRAM */

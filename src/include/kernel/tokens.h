...
/* Multi DAI */
#define SOF_TKN_MULTIDAI_SUBTYPE		1400
#define SOF_TKN_MULTIDAI_INDEX0			1401
#define SOF_TKN_MULTIDAI_INDEX1			1402
#define SOF_TKN_MULTIDAI_INDEX2			1403
#define SOF_TKN_MULTIDAI_INDEX3			1404

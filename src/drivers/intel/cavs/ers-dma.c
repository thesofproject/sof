...
/* DGMBS align value */
#define ERS_DMA_BUFFER_ALIGNMENT	0x20
#define ERS_DMA_COPY_ALIGNMENT		0x20
...
static int ers_dma_get_attribute(struct dma *dma, uint32_t type,
				 uint32_t *value)
{
	int ret = 0;
	...
	case DMA_ATTR_BUFFER_ALIGNMENT:
		*value = ERS_DMA_BUFFER_ALIGNMENT;
		break;
	case DMA_ATTR_COPY_ALIGNMENT:
		*value = ERS_DMA_COPY_ALIGNMENT;
		break;
	default:
		ret = -EINVAL;
		break;
...
const struct dma_ops ers_dma_ops = {
	...
	.get_attribute		= ers_dma_get_attribute,
};

			      ...
			      struct dma_sg_config *config)
{
	...
	if (config->direction ==  DMA_DIR_MEM_TO_DEV) {
		...
		sp_fifo_addr = SP_TX_FIFO_ADDR;
		io_reg_write((PU_REGISTER_BASE + ACP_P1_I2S_TX_FIFOADDR), sp_fifo_addr);
		io_reg_write((PU_REGISTER_BASE + ACP_P1_I2S_TX_FIFOSIZE), (uint32_t)(SP_FIFO_SIZE));
		...
		io_reg_write((PU_REGISTER_BASE + ACP_P1_I2S_TX_DMA_SIZE),
		...
		sp_fifo_addr = SP_RX_FIFO_ADDR;
		io_reg_write((PU_REGISTER_BASE + ACP_P1_I2S_RX_FIFOADDR), sp_fifo_addr);
		io_reg_write((PU_REGISTER_BASE + ACP_P1_I2S_RX_FIFOSIZE),
		...
		io_reg_write((PU_REGISTER_BASE + ACP_P1_I2S_RX_DMA_SIZE),
			     (uint32_t)(ACP_DMA_TRANS_SIZE_128));

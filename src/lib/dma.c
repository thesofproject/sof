...
/*
 * Used when copying DMA buffer bytes into multiple sink buffers, one at a time. The DMA buffer
 * consume should be performed after the data has been copied to all sinks
 */

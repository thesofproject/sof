...
CONTROLENUM_LIST(dai_enums, LIST(`  ', `"a2dp"', `"sco"'))

# Demux enum control
C_CONTROLENUM(dai_control, 1,
        dai_enums,
        LIST(`  ', ENUM_CHANNEL(FL, 3, 0), ENUM_CHANNEL(FR, 3, 1)),
        CONTROLENUM_OPS(enum, 257 binds the mixer control to bytes get/put handlers,
	257, 257))
...
DAI_ADD(sof/pipe-dai-playback.m4,
	...
	1000, 0, 0, SSP_SCHEDULE_TIME_DOMAIN, 2, 48000, 0, dai_control)
...
DAI_ADD(sof/pipe-dai-capture.m4,
	...
	1000, 0, 0, SSP_SCHEDULE_TIME_DOMAIN, 2, 48000, 0)

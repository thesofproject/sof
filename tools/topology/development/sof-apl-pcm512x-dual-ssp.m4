#
# Topology for testing multi ssp in Apollolake UP^2.
#
...
# Low Latency playback pipeline 1 on PCM 0 using max 2 channels.
# multiple SSP configs are defined below, pipeline's using 1-2 channels
# and `S32_LE,S24_LE,S16_LE' format
# Set 1000us deadline on core 0 with priority 0
PIPELINE_PCM_ADD(sof/pipe-passthrough-playback-variable.m4,
	1, 0, 2, s32le,
	1000, 0, 0,
	8000, 48000, 48000)

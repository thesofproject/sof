#
# HDA passthrough topology for WHL
#
...
#
# PCM0  <---> passthrough (pipe 1,2) <----> HDA Analog (HDA Analog playback/capture)
# PCM1  <---> passthrough (pipe 3,4) <----> HDA Digital (HDA Digital playback/capture)
# PCM3  ----> passthrough (pipe 7)   -----> iDisp1 (HDMI/DP playback, BE link 3)
# PCM4  ----> passthrough (pipe 8)   -----> iDisp2 (HDMI/DP playback, BE link 4)

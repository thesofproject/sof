...
#
#  Low Latency Capture with demux and volume.
#
...
W_PGA(0, PIPELINE_FORMAT, DAI_PERIODS, 2, playback_pga_conf, LIST(`		', "PIPELINE_ID Master Capture Volume"))
...
#
#  host PCM_P -- B0 <--- volume -- B1 <--- Demux-- B2 <-- sink DAI0
P_GRAPH(pipe-demux-vol-capture-PIPELINE_ID, PIPELINE_ID,
	LIST(`		',
...
PCM_CAPABILITIES(Low Latency Capture PCM_ID, `S32_LE,S24_LE,S16_LE', 48000, 48000, 2, PIPELINE_CHANNELS, 2, 16, 192, 16384, 65536, 65536)

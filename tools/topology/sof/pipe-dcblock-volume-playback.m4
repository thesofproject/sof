...
# DC Block Bytes control with max value of 180
...
# DCBLOCK priv in amp_bytes.m4 (ABI header (32 bytes) + 12 dwords) requires 80 bytes
# Therefore at least 172 bytes are required for this kcontrol
# Any value lower than that would end up in a topology load error
 C_CONTROLBYTES(DCBLOCK, PIPELINE_ID,
...
W_DCBLOCK(0, PIPELINE_FORMAT, 2, 2, LIST(`   ', "DCBLOCK"))

...
#
# PCM6 <--- ASRC <--- Volume <--- DMIC6 (DMIC01)
# PCM7 <--- ASRC <--- Volume <--- DMIC7 (DMIC16k)
#
...
# ASRC capture pipeline 6 on PCM 6 using max channels 2.
...
# ASRC capture pipeline 7 on PCM 7 using max channels 2.
# Set 1000us deadline on core 0 with priority 0
PIPELINE_PCM_ADD(sof/pipe-asrc-volume-capture.m4,
	7, 7, 2, s32le,
	1000, 0, 0,

...
ifdef(`DMIC_PIPELINE_16k_CORE_ID',`',define(DMIC_PIPELINE_16k_CORE_ID, 0))
...
PIPELINE_PCM_ADD(sof/pipe-DMIC16KPROC-capture-16khz.m4,
	...
	250, 0, DMIC_PIPELINE_16k_CORE_ID, 16000, 16000, 16000)
...
DAI_ADD(sof/pipe-dai-capture.m4,
	...
	4000, 0, DMIC_PIPELINE_16k_CORE_ID, SCHEDULE_TIME_DOMAIN_TIMER)

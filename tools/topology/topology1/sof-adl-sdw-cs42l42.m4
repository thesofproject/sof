...
# playback DAI is ALH(SDW1 PIN258) using 2 periods
...
# capture DAI is ALH(SDW1 PIN259) using 2 periods
# Buffers use s24le format, with 48 frame per 1000us on core 0 with priority 0
...
PCM_PLAYBACK_ADD(CS42L42 Jack Out, 0, PIPELINE_PCM_30)
ifdef(`HEADSET_DEEP_BUFFER',
`
PCM_PLAYBACK_ADD(Jack Out DeepBuffer, 31, PIPELINE_PCM_31)
'
)
PCM_CAPTURE_ADD(CS42L42 Jack In, 1, PIPELINE_PCM_2)
ifdef(`EXT_AMP',
`

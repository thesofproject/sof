...
ifdef(`PIPELINE_FILTER2', , `define(PIPELINE_FILTER2, eq_iir_coef_highpass_40hz_0db_16khz.m4)')
...
W_BUFFER(0, COMP_BUFFER_SIZE(2,
	...
	COMP_PERIOD_FRAMES(PCM_MAX_RATE, SCHEDULE_PERIOD)), PLATFORM_PASS_MEM_CAP, SCHEDULE_CORE)
...
P_GRAPH(pipe-tdfb-eq-iir-volume-capture-16khz, PIPELINE_ID,
	LIST(`		',

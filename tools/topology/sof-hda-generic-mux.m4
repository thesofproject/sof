...
define(matrix2, `ROUTE_MATRIX(12,
			     `BITS_TO_BYTE(0, 0, 0 ,0 ,0 ,0 ,0 ,0)',
...
MUXDEMUX_CONFIG(mux_priv_1, 2, LIST(`	', `matrix1,', `matrix2'))
...
PIPELINE_PCM_ADD(sof/pipe-volume-mux-playback.m4,
	1, 0, 2, s24le,
	1000, 0, 0,
	48000, 48000, 48000)
...
PIPELINE_PCM_ADD(sof/pipe-volume-playback-sched.m4,
	12, 8, 2, s24le,
	1000, 1, 0,
	48000, 48000, 48000,
...
#PCM_PLAYBACK_ADD(Mux, 8, PIPELINE_PCM_12)

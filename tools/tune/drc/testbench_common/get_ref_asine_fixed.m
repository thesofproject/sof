...
function refasinfixed = get_ref_asine_fixed(path,filename)
%---------------------------------------------------
%---------------------------------------
%   History
%---------------------------------------
...
if exist(fullFileName, 'file')
    ...
    refasinfixed = table;
    refasinfixed.Index = dataArray{:, 1};
    refasinfixed.InvalXq230 = dataArray{:, 2};
    refasinfixed.OutvalYq131 = dataArray{:, 3};

function example_two_beams_default()
...
prm.export_note = 'Created with script example_two_beams_default.m';
prm.export_howto = 'cd tools/tune/tdfb; matlab -nodisplay -nosplash -nodesktop -r example_two_beams_default';
prm.type = 'DSB';
prm.add_beam_off = 1;
...
for fs = [16e3 48e3]
	...
	bf_line2_two_beams(fs, d, a1, a2, fn, prm);
	...
	a1 = az;   % Azimuth +az deg
	a2 = -az;  % Azimuth -az deg
	bf_line4_two_beams(fs, d, a1, a2, fn, prm);
end

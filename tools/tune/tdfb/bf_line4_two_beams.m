function bf_line4_two_beams(fs, d, a1, a2, fn, prm);

% bf_line4_two_beams(fs, d, a1, a2, fn, add_beam_off)
% Input
%   fs - sample rate
...
%   prm.add_beam_beam_off - controls addition of beam off definition to blob
%      .type - Use 'SDB' or 'DSB'

...
static struct test_case test_cases[] = {
	...
	TEST_CASE(1,  SOF_MEM_FLAG_USER,
		  2, TEST_BULK, "rmalloc_dma"),
	TEST_CASE(4, SOF_MEM_FLAG_USER,
		  2, TEST_BULK, "rmalloc_dma"),
	TEST_CASE(256, SOF_MEM_FLAG_USER,
		  2, TEST_BULK, "rmalloc_dma"),
	...
	TEST_CASE(4,   SOF_MEM_FLAG_USER, 1024,
	...
	TEST_CASE(16,  SOF_MEM_FLAG_USER, 64, TEST_BULK,
		  "rballoc"),
	TEST_CASE(4,   SOF_MEM_FLAG_USER, 64, TEST_BULK,
		  "rballoc"),

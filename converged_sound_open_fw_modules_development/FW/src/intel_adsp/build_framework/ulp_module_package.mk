...
$(info ulp_module_package.mk $(MAKECMDGOALS))
...
CXXFLAGS += $(sort \
  ...
  -I$(SRCDIR)/src/common \
  -I$(SRCDIR)/src/common/ulp \
  -I$(SRCDIR)/src/common/ulp/common \
  -I$(SRCDIR)/src/ulp/common \
  -I$(SRCDIR)/src/ulp/ \
  -I$(SRCDIR)/src/ulp/common/include \
  -I$(SRCDIR)/src/common/internal/include \
  -I$(SRCDIR)/src/common/include \
  -I$(SRCDIR)/portable/architecture/xtensa_lx/include \
  -I$(SRCDIR)/portable/platform/$(PLATFORM)-ulp/include/platform \
...
ifneq ($(abspath $(OUT_DIR)),$(CURDIR))
  ...
  ifeq (,$(filter usage help,$(_MAKECMDGOALS)))
    ...
    $(info get_obj_files_list: $(get_obj_files_list))

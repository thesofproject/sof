...
public:
    ...
    */
    void Detach() { data_ = NULL; size_ = 0; }
    /*!
    ...
    */
    size_t alloc_size() const { return size()*sizeof(T); }
    /*!
      Resizes the array.
    */
    ...
    */
    ...
    /*!
      ...
      \return Reference ot the element.
    */
    ...
    */
    ...
    /*!
      ...
      \param dst_offset Offset in the destination array to start copying data at (expressed in number of items).
    */
    void copyFrom(const Array<T>& src, size_t dst_offset = 0) {
        assert(data() != 0);
        assert(size() > dst_offset);
        assert((size() - dst_offset) >= src.size());
        memcpy_s(data() + dst_offset, alloc_size() - dst_offset * sizeof(T), src.data(), src.alloc_size());
        return;
    }
    /*!
    ...
    */
    ...
    /*!
      Safe zero-memory on the underlaying buffer.
    */
    void clear() {

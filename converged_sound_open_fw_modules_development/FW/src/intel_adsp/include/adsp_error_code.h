 ...
 * NOTE: intel_adsp::ErrorCode should be merged into this namespaceless type to be used in 3rd party's C code.
 */
 ...
 * Upon this error code the ADSP System is asked to stop any interactions with the module instance. */

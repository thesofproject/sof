...
namespace intel_adsp
{
     ...
     *
     * A custom module is required to provide to the ADSP System some PinEndpoint value arrays. Arrays length shall be as long
     * as it has input and output pins.
     ...
     * Those sinks and sources objects shall be instantiated by the custom module and delivered to the ADSP System
     * with this IoPinsInfo structure (through \ref ProcessingModuleFactoryInterface::Create()).
     *
     * \note The "pin" of a module is purely conceptual and has no programmatic correspondence.
     * A module has as many input/output pins as input/output streams which can be driven through it.
     */
    struct IoPinsInfo
    {
        /*!
         ...
         *
         * A module is required to provide some PinEndpoint arrays to allow the ADSP System to drive stream out of the module.
         */
        PinEndpoint* sinks;
    ...
    /*!
     * \brief The ProcessingModuleFactoryInterface class defines requirements for creating a processing module controllable by the ADSP System. */
    class ProcessingModuleFactoryInterface
    {
    public:
        /*!
         * \brief Scoped enumeration of error code value which can be reported by a ProcessingModuleFactoryInterface object */
        struct ErrorCode : intel_adsp::ErrorCode
        {
            /*! \brief list of named error codes specific to the ProcessingModuleFactoryInterface */
            enum Enum
            {
                INVALID_IBS = intel_adsp::ErrorCode::MaxValue+1 /*!< Reports that the given value of Input Buffer Size is invalid */,
                INVALID_OBS /*!< Reports that the given value of Output Buffer Size is invalid */,
                INVALID_CPC /*!< Reports that the given value of Cycles Per Chunk processing is invalid */,
                INVALID_SETTINGS /*!< Reports that the settings provided for module creation are invalid */
            };
        ...
        virtual void GetPrerequisites(
                                ProcessingModulePrerequisites& module_prereqs
                            ) = 0;
        /*!
         ...
         * \note The ADSP System will provide a dedicated memory \e placeholder for every module instance to create.
         *
         ...
         * \param [out] pins_info will report the IoPinsInfo data that ADSP System requires to bind the input and output streams to the module.

...
{
    /*!
     * \brief "Scoped enumeration" of values which specify data buffer alignment of input or output stream buffer.
     */
    struct StreamBufferAlignment
    {
        /*! \brief the enumation type of StreamBufferAlignment "scoped enumeration" */
        enum WordSize
        {
        ...
        /*! \brief Initializes a new instance of StreamBufferAlignment with value set to _4_BYTES */
        StreamBufferAlignment()
            :   value(_4_BYTES)
        {}

        /*! \brief Initializes a new instance of StreamBufferAlignment given a StreamBufferAlignment::WordSize value */
        StreamBufferAlignment(WordSize val)
            :   value(val)
        {}

        /*! \brief Initializes a new instance of StreamBufferAlignment given a StreamBufferAlignment::Type value */
    ...
    {
    public:
        /*! \brief Initializes a new instance of ProcessingModulePrerequisites with default values
         */
        ProcessingModulePrerequisites()
            :   stream_buffer_alignment(StreamBufferAlignment::_4_BYTES),
                input_pins_count(0), output_pins_count(0)
        {}

        /*! \brief holds the buffer alignment constraint in size of bytes for input or output chunk buffer
         *
         * Default constructor set this field value to StreamBufferAlignment::_4_BYTES.
         */
        StreamBufferAlignment stream_buffer_alignment;

        /*! \brief Indicates the count of input pins for the module type about to be created.
         */
        size_t input_pins_count;
        /*! \brief Indicates the count of output pins for the module type about to be created.
         */
